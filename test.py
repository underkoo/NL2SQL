...
def do_test(args):
    ...
    model = Predictor(word_emb, N_word=N_word, use_ca=args.ca, use_cnn=args.cnn, use_col_cnn=args.col_cnn, use_op_cnn=args.op_cnn, filter_num=args.filter_num, cnn_type=args.cnn_type, gpu=GPU,
