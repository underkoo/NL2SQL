    ...
    def __init__(self, word_emb, N_word, N_h=200, N_depth=2,
        ...
        if cond:
            self.cond_pred = CondPredictor(N_word, N_h, N_depth,
                self.max_col_num, self.max_tok_num, use_ca=use_ca, use_cnn=use_cnn, use_num_cnn=use_num_cnn, use_col_cnn=use_col_cnn, use_op_cnn=use_op_cnn, use_val_cnn=use_val_cnn, filter_num=filter_num, cnn_type=cnn_type, use_detach=use_detach, gpu=gpu)
